...
// ============================================
// KONFIGURASI - dari .env (Vite)
// ============================================
const SHEETS_WEB_APP_URL = import.meta.env.VITE_APPS_SCRIPT_URL;

if (!SHEETS_WEB_APP_URL || SHEETS_WEB_APP_URL === 'https://script.google.com/macros/s/YOUR_SCRIPT_ID/exec') {
  console.warn('[Sheets] WARNING: Apps Script URL belum di-set di .env!');
}
...
export async function syncToGoogleSheets(data) {
  ...
  if (!SHEETS_WEB_APP_URL) {
    console.warn('[Sheets] Apps Script URL tidak tersedia, sync dilewati');
